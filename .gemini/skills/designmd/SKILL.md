...
powershell.exe -NoProfile -Command "python .gemini/skills/designmd/scripts/index_design.py ψ/memory/design/<creator-kit-name>.DESIGN.md ψ/memory/design/REGISTRY.json"
```
