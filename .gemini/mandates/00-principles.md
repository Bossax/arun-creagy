...
Never assume "knowledge" of a concept based on its name. Every definition or configuration must be audited from the current `ψ/` brain or environment state in the active turn.
