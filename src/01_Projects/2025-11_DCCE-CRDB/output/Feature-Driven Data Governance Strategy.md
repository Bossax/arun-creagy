...
*   **Governance Integration:**
    ...
    3.   **Essential Classification:** Apply the `Data_Classification_Policy.md` to the initial dataset to prevent accidental exposure of sensitive information. <!--note: If DCCE has set the data classification standard and SOP, would it help DCCE to be able to take on legal accountability so that they can access sensitive individual data?-->
...
* **Action:** Begin evolving the NCAIF portal towards the more sophisticated "User-Journey-Based" model, starting with features for "Policy Makers & Planners" (e.g., a National Progress Dashboard). <!--note: we could include a user journey model of Policy Makers & Planners in phase 1 to demonstrate? To answer this question, we will need to extract insight from the interviews. --> <!--todo:  find the framing to extract insight from interview to make the decision-->
*   **Governance Integration:**
    *   **Grow the Stewardship Program:** Recruit and train additional Data Stewards from agencies providing data for the new features. Foster a community of practice. <!--note: what would be an incentive for data owner agency? learn from NSO's lesson of building capacity for the data owners [[Interview Summary - NSO]]-->
    ...
    *   **Data Literacy Workshops:** Conduct practical workshops for DCCE staff, using the live NCAIF portal to teach data interpretation and management skills relevant to their jobs. <!--comment: we won't have a live portal until the end of the next financial year (the platform development project is planned for budget request in 2027FY, this project ends in August of 2026 FY-->
