...
4. การประเมินสถานะความพร้อมใช้ 3 ระดับ พร้อมระบุรหัสเหตุผลสำหรับรายการที่ใช้ประโยชน์ได้ยากตามเกณฑ์ที่ขอบเขตงานกำหนด
...
ในการวิเคราะห์เปรียบเทียบ คณะที่ปรึกษาให้ความสำคัญกับการแยกแยะระหว่าง **"จำนวนชุดข้อมูลจามความต้องการ (Demand Needs)"** ออกจาก **"จำนวนชุดข้อมูลที่มีอยู่จริงในบัญชีชุดข้อมูลพื้นฐาน (Data Inventory)"** เพื่อป้องกันความเข้าใจคลาดเคลื่อน ตัวอย่างเช่น ในหมวด Exposure หน่วยงานมีความต้องการข้อมูลที่ที่มีอยู่ในบัญชีจำนวน 14 รายการ แต่ในบัญชีรายการข้อมูลพื้นฐานมีชุดข้อมูลด้านสินทรัพย์และการเปิดรับภัยอยู่ 71 ชุดข้อมูล หมายความว่า ข้อมูลที่ผู้ใช้ต้องการใช้จริง ไม่จำเป็นต้องเท่ากับชุดข้อมูลที่มีทั้งหมดในบัญชีชุดข้อมูล หลายชุดข้อมูลอาจจะไม่ถูกใช้โดยกลุ่มผู้มีส่วนได้ส่วนเสียที่ที่ปรึกษาได้เก็บข้อมูลภายใต้โครงการนี้
...
**ตารางที่ 5-4: ผลการเปรียบเทียบข้อกำหนดระดับชุดข้อมูลกับบัญชีรายการข้อมูลพื้นฐาน จำแนกตามหมวดข้อมูลและสถานะ (165 รายการ)**
...
จากการวิเคราะห์ผลลัพธ์ในตารางที่ 5-4 ร่วมกับข้อเท็จจริงเชิงประจักษ์ของชุดข้อมูล คณะที่ปรึกษามีข้อสังเกตสำคัญในแต่ละหมวดข้อมูลดังนี้:
...
สำหรับฝั่งผลิตภัณฑ์สารสนเทศ คณะที่ปรึกษานำข้อกำหนดระดับผลิตภัณฑ์ 52 รายการ ตรวจสอบกับบัญชีรายการผลิตภัณฑ์สารสนเทศตามขอบเขตงานข้อ 5.3.4 ผลการวิเคราะห์แสดงดังตารางที่ 5-5

**ตารางที่ 5-5: ผลการเปรียบเทียบข้อกำหนดระดับผลิตภัณฑ์สารสนเทศกับบัญชีรายการผลิตภัณฑ์สารสนเทศ จำแนกตามสถานะ (52 รายการ)**
