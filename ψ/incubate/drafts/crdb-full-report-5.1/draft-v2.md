...
2. **Hazard (ข้อกำหนด 79 รายการ / บัญชีข้อมูล 62 ชุดข้อมูลครอบคลุม — ร้อยละ 78.5)**:
   - *การมุ่งเน้นข้อมูลภัยพิบัติทางกายภาพ*: หมวด Hazard มีปริมาณข้อกำหนดสูงที่สุดถึง 79 รายการ (คิดเป็นเกือบครึ่งหนึ่งของข้อกำหนดระดับชุดข้อมูลทั้งหมด) เนื่องจากหน่วยงานส่วนใหญ่คุ้นเคยกับการใช้แผนที่น้ำท่วมหรือแผนที่ภัยแล้งในการปฏิบัติงาน จึงระบุความต้องการข้อมูลในหมวดนี้เป็นสัดส่วนสูงที่สุด
...
3. **Exposure (ข้อกำหนด 14 รายการ / บัญชีข้อมูล 13 ชุดข้อมูลครอบคลุม — ร้อยละ 92.9)**:
   - *ขอบเขตข้อมูลสินทรัพย์*: ข้อกำหนด 14 รายการระบุถึงสินทรัพย์ทางกายภาพโดยตรง (เช่น แนวถนน นิคมอุตสาหกรรม พื้นที่เกษตรกรรม อาคารสถานพยาบาล) โดยยังมีการระบุข้อมูลการเปิดรับภัยเชิงระบบ (เช่น โครงข่ายโลจิสติกส์และห่วงโซ่อุปทาน) ในระดับที่จำกัด
...
4. **Sensitivity & Adaptive Capacity (ข้อกำหนด 17 รายการ / บัญชีข้อมูล 10 ชุดข้อมูลครอบคลุม — ร้อยละ 58.8)**:
   ...
   - *ข้อจำกัดด้านการเปิดเผยข้อมูลส่วนบุคคล (PDPA)*: ข้อมูลกลุ่มเปราะบางทางสังคม (เช่น ผู้สูงอายุ ผู้พิการ ผู้ป่วยติดเตียง และผู้มีรายได้น้อย) ของกระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์ (พม.) ถูกจัดเก็บภายใต้สถานะจำกัดสิทธิ (Restricted) เนื่องจากเป็นข้อมูลส่วนบุคคลตามพระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล (PDPA) ซึ่งหน่วยงานผู้ถือครองข้อมูลยังมิได้ประมวลผลสรุปเป็นสถิติภาพรวมรายพื้นที่ (เช่น ระดับตำบล) เพื่อเผยแพร่เป็นข้อมูลสาธารณะ
...
5. **Impact & Loss and Damage (ข้อกำหนด 28 รายการ / บัญชีข้อมูล 16 ชุดข้อมูลครอบคลุม — ร้อยละ 57.1)**:
   ...
   - *ลักษณะของระบบรายงานสาธารณภัย*: ฐานข้อมูลสถิติสาธารณภัยและรายงานการสงเคราะห์ผู้ประสบภัยของ ปภ. เป็นระบบการรายงานจากพื้นที่เพื่อประโยชน์ในการสงเคราะห์เยียวยา ขาดกระบวนการตรวจสอบยืนยันข้อมูลจากส่วนกลาง และยังไม่ได้จัดหมวดหมู่ประเภทภัยตามกรอบสากลของ Sendai Framework / UNDRR
...
2. **กลุ่มเครื่องมือและระเบียบวิธีวิเคราะห์ที่ยังไม่มีการพัฒนาในประเทศ จำนวน 40 รายการ (ร้อยละ 76.9)**: เป็นเครื่องมือและระเบียบวิธีวิเคราะห์เฉพาะทางที่ยังไม่มีหน่วยงานใดจัดทำขึ้นอย่างเป็นมาตรฐานกลาง เช่น ฟังก์ชันความเสียหาย (Damage Functions) เครื่องมือวิเคราะห์ต้นทุนและผลประโยชน์ (CBA) และแบบจำลองการระบายน้ำระดับเมือง
...
ข้อค้นพบนี้ชี้ว่า กาจะปิดช่องว่างเหล่านี้ ต้องใช้การดำเนินงานสองแนวทางควบคู่กัน คือ การปรับปรุงสิทธิการเข้าถึงและมาตรฐานข้อมูลสำหรับฝั่งชุดข้อมูลพื้นฐาน ควบคู่กับการวิจัยพัฒนาระเบียบวิธีการ และผลิตบริการสารสนเทศที่ตอบโจทย์ผู้ใช้จริง
...
หมวด Exposure ในบัญชีชุดข้อมูลพื้นฐานมีข้อมูลสินทรัพย์ทางกายภาพส่วนใหญ่ของประเทศแล้ว  เช่น แนวถนน แปลงพืชเกษตร และพิกัดสถานที่สำคัญ  ซึ่งมีหน่วยงานรัฐจัดเก็บครอบคลุมพอสมควรอล้ว
...
นอกจากรหัสเหตุผลระดับรายการแล้ว จุดอ่อนเชิงคุณภาพของระบบข้อมูลยังได้รับการยืนยันผ่านความสอดคล้องของหลักฐานสองแหล่ง กล่าวคือ ข้อกำหนดข้อมูลจากพันธกรณีการรายงานความโปร่งใสระดับสากล (A-BTR) และคำอธิบายข้อจำกัดการใช้งานของฐานข้อมูลสถิติสาธารณภัยของกรมป้องกันและบรรเทาสาธารณภัย ต่างระบุข้อจำกัดในลักษณะเดียวกัน คือการรายงานข้อมูลสาธารณภัยเป็นระบบรายงานเพื่อการสงเคราะห์ ขาดการตรวจสอบยืนยันความถูกต้องจากส่วนกลาง และยังไม่สอดคล้องกับกรอบการจำแนกประเภทภัยสากลของสำนักงานเพื่อการลดความเสี่ยงจากภัยพิบัติแห่งสหประชาชาติ (UNDRR) ซึ่งชี้ว่าคุณภาพของข้อมูลความสูญเสียและเสียหายจำเป็นต้องได้รับการยกระดับมาตรฐาน ทั้งนี้ การประเมินความพร้อมใช้งานในภาพรวมยังสะท้อนผลผ่านการสำรวจความพร้อมเนื้อหาเว็บไซต์จำนวน 75 หัวข้อ ซึ่งพบข้อจำกัดด้านการให้บริการข้อมูลสาธารณะในลักษณะเดียวกันตามรายละเอียดที่รายงานไว้ในภาคผนวก

## 5.1.5 ช่องว่างที่ต้องแก้ไขด้วยการพัฒนาระเบียบวิธีและการตัดสินใจเชิงนโยบาย

รายการความต้องการประเภทผลิตภัณฑ์สารสนเทศที่ยังไม่มีจำนวน 40 รายการ มีลักษณะของช่องว่างที่แตกต่างจากฝั่งชุดข้อมูลพื้นฐาน ฝั่งชุดข้อมูลส่วนใหญ่มีตัวข้อมูลดิบอยู่แล้วในหน่วยงานแต่ติดขัดเรื่องการเข้าถึง ข้อมูลอภิพันธ์ หรือรูปแบบไฟล์ ขณะที่ฝั่งผลิตภัณฑ์สารสนเทศเป็นเครื่องมือและระเบียบวิธีวิเคราะห์เฉพาะทางที่ยังไม่มีการพัฒนาขึ้นในประเทศ ซึ่งต้องอาศัยการศึกษาวิจัย การพัฒนาระเบียบวิธีมาตรฐาน และการกำหนดนโยบายของหน่วยงานเจ้าภาพ โดยมีประเด็นสำคัญ 6 ประการ ได้แก่:
...
ตารางที่ 5-6 รวบรวมภาพรวมช่องว่างทั้งหมดจำแนกตามหมวดข้อมูลตามขอบเขตงานข้อ 5.3.5 และประเภทการตอบสนองที่จำเป็น เพื่อส่งต่อหลักฐาน ทั้งหมดไปยังหัวข้อ 5.2 ในการจัดลำดับความสำคัญและออกแบบชุดข้อเสนอแนะเชิงมาตรการต่อไป
