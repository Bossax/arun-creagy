...
1. **Hazard**:
	...
	- *การมีอยู่ของดัชนีภูมิอากาศในอนาคต*: กรม สส. ได้จัดทำดัชนีภัยพิบัติในอนาคตและเปิดให้ดาวน์โหลดผ่านฐานข้อมูลความเสี่ยงเชิงพื้นที่ผ่านระบบ CCIC ซึ่ง ครอบคลุม 77 จังหวัด และ 5 ช่วงเวลาตามฉากทัศน์ SSP2-4.5 และ SSP5-8.5 ซึ่งมีดัชนีภัย 24 ตัวแปร รวมถึงดัชนีความถี่และจำนวนครั้งของการเกิดน้ำท่วมและภัยแล้ง (เช่น จำนวนวันฝนตกหนัก ความถี่น้ำท่วม ดัชนีฝนแล้ง SPI และจำนวนวันแล้งต่อเนื่อง)
	- *สาเหตุที่ความต้องการ 50 รายการยังตกอยู่ในสถานะ "มีแต่ใช้ประโยชน์ได้ยาก"*:  ข้อมูลภัยพิบัติของประเทศมิได้ขาดแคลน แต่ติดข้อจำกัดเชิงโครงสร้าง 3 ประการ:
...
6. **Sensitivity & Adaptive Capacity (ความต้องการ 17 รายการ / บัญชีข้อมูล 72 ชุดข้อมูล)**:
...
1. **Response**
	...
	- *การขาดระบบติดตามและประเมินผล*: ข้อมูลมาตรการส่วนใหญ่ยังเน้นรายงานตัวชี้วัดระดับผลผลิต (Output Indicators) เช่น จำนวนจุดบริการ หรือจำนวนผู้เข้ารับการอบรม แต่ยังขาดตัวชี้วัดระดับผลลัพธ์ (Outcome Indicators) ที่ประเมินว่ามาตรการเหล่านี้ช่วยลดความเปราะบางหรือความสูญเสียได้จริงเพียงใด

สำหรับฝั่งผลิตภัณฑ์สารสนเทศ คณะที่ปรึกษานำข้อกำหนดระดับผลิตภัณฑ์สารสนเทศ 52 รายการ ไปตรวจสอบเปรียบเทียบกับบัญชีรายการผลิตภัณฑ์สารสนเทศตามขอบเขตงานข้อ 5.3.4 (รวบรวมได้ 114 ผลิตภัณฑ์จาก 56 หน่วยงาน) ผ่านเกณฑ์กรอง 2 ขั้นตอนในลักษณะเดียวกัน โดยพบผลลัพธ์ที่ตรงกันข้ามกับฝั่งชุดข้อมูลอย่างสิ้นเชิง

**ขั้นตอนที่ 1: การตรวจสอบการมีอยู่จริงของผลิตภัณฑ์ในระบบ **
- **ยังไม่มีผลิตภัณฑ์ในระบบของประเทศเลย**: **40 รายการ (คิดเป็นร้อยละ 76.9)** ถือเป็นช่องว่างขนาดใหญ่ที่สุด ซึ่งเกิดจากการที่ประเทศยังไม่เคยสร้างขีดความสามารถหรือพัฒนาระเบียบวิธีเหล่านี้ขึ้นมาก่อน (Capabilities Never Built) เช่น ฟังก์ชันความเสียหาย (Damage Functions) และแบบจำลองผังเมืองเชิงนิเวศ
- **มีผลิตภัณฑ์ในบัญชีรายการรองรับ**: **8 รายการ (คิดเป็นร้อยละ 15.4)**
- *(หมายเหตุ: อีก 4 รายการ (ร้อยละ 7.7) เป็นข้อกำหนดเชิงคุณลักษณะและมาตรฐานกลาง เช่น เกณฑ์ความละเอียดกริด ซึ่งส่งต่อไปกำหนดในบทที่ 2)*

**ขั้นตอนที่ 2: การประเมินสถานะความพร้อมใช้งานจริงในบรรดาผลิตภัณฑ์ที่มี 
ในบรรดาผลิตภัณฑ์ 8 รายการที่มีอยู่ในระบบของประเทศ
1) **มีและใช้ได้**: มีจำนวน **4 รายการ** (คิดเป็นร้อยละ 50.0 ของผลิตภัณฑ์ที่มี) ได้แก่ ผลิตภัณฑ์แผนที่และดัชนีความเสี่ยงที่ กรม สส. และกรมอุตุนิยมวิทยาพัฒนาขึ้นบนแพลตฟอร์ม CCIC
2) **มีแต่ใช้ประโยชน์ได้ยาก**: มีจำนวน **4 รายการ** (คิดเป็นร้อยละ 50.0 ของผลิตภัณฑ์ที่มี) เนื่องจากถูกออกแบบมาเพื่อภารกิจเตือนภัยพิบัติระยะสั้น 1–3 วัน หรือมีความละเอียดหยาบระดับอำเภอ/จังหวัด ไม่ตอบโจทย์การประเมินความเสี่ยงระยะยาวตามฉากทัศน์สภาพภูมิอากาศ

ผลการวิเคราะห์ระดับผลิตภัณฑ์สารสนเทศแสดงดังตารางที่ 5-5

**ตารางที่ 5-5: การครอบคลุมของบัญชีผลิตภัณฑ์สารสนเทศต่อข้อกำหนดระดับผลิตภัณฑ์สารสนเทศ จำแนกตามสถานะ (52 รายการ)**

| สถานะความพร้อมใช้          | จำนวน  | ตัวอย่างผลิตภัณฑ์สารสนเทศ                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | ข้อสังเกต                                                                                                                                                                                                                                                                                                                                                                                                                                           |                                                                                                                                                                                                                                                                                                                                                |                                                    |
| -------------------------- | :----: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| **มีและใช้ได้**            | **4**  | *                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | • แผนที่ความเสี่ยงสภาพภูมิอากาศรายสาขาของ กรม สส. (DCCE Climate-related Risk Maps)<br>• ผลลัพธ์แบบจำลองภูมิอากาศ CMIP6 และการลดขนาดทางสถิติปริมาณฝนและอุณหภูมิ<br>• แพลตฟอร์มดัชนีความร้อนเชิงพื้นที่ของ กรม สส. และกรมอุตุนิยมว                                                                                                                                                                                                                    | ผลิตภัณฑ์ที่มีและใช้ได้กระจุกตัวอยู่ที่ผลงานที่ กรม สส. พัฒนาขึ้นเอง ซึ่งมีระบบ CCIC ที่เปิดให้สืบค้นและดาวน์โหลดไฟล์ตารางสถิติ (CSV/Excel) สำหรับ 24 ดัชนีความเสี่ยงรายสาขา (6 สาขา NAP) ครอบคลุม 77 จังหวัด และ 5 ช่วงเวลาตามฉากทัศน์ SSP245 และ SSP585 ได้จริง แต่ผู้ใช้ระดับปฏิบัติการยังต้องการการต่อยอดสู่ชั้นข้อมูลเชิงพื้นที่ระดับกริด |                                                    |
| **มีแต่ใช้ประโยชน์ได้ยาก** | **4**  | 4**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | • แพลตฟอร์มข้อมูลสาธารณภัยของ GISTDA และแดชบอร์ดแผนที่ความเสี่ยงของ ปภ.: ความละเอียดแสดงผลในระดับอำเภอหรือจังหวัด ไม่ถึงระดับ 10 กิโลเมตร หรือระดับแปลงที่ดิน (`spatial_detail`)<br>• ระบบพยากรณ์น้ำท่วมและดินถล่มล่วงหน้าของ สสน. และกรมทรัพยากรน้ำ: เป็นแผนที่เตือนภัยระยะสั้น 1–3 วัน มิใช่ฉากทัศน์สภาพภูมิอากาศระยะยาว (`uncertainty_info`)<br>• ระบบจำลองระดับน้ำทะเลในอ่าวไทย: ขาดการเปิดเผยช่วงความเชื่อมั่นของแบบจำลอง CMIP6 (`uncertainty_ | ผลิตภัณฑ์มีอยู่จริงแต่ถูกออกแบบมาเพื่อภารกิจเตือนภัยเฉพาะหน้า มิได้ออกแบบมาเพื่อรองรับการประเมินความเสี่ยงระยะยาวตามฉากทัศน์ SSP                                                                                                                                                                                                               |                                                    |
| **ยังไม่มี**               | **40** | • **กลุ่มฟังก์ชันความเสียหาย (Damage Functions)**: ขาดสูตรคำนวณแปลงความลึกน้ำท่วมเป็นมูลค่าความเสียหายต่อสิ่งปลูกสร้างและพืชผล<br>• **กลุ่มแบบจำลองผังเมือง (Urban InVest)**: ขาดเครื่องมือประเมินศักยภาพการระบายน้ำและการกักเก็บน้ำของพื้นที่เมือง<br>• **กลุ่มดัชนีมาตรฐาน**: ขาดดัชนีความเปราะบางรายปี (Yearly Vulnerability Index) และดัชนีความยืดหยุ่นเชิงสถาบัน (Institutional Resilience Index) เป็นต้น<br>• **กลุ่มกรอบความสูญเสียสากล**: ขาดคู่มือและเครื่องมือการประเมินความสูญเสียและความเสียหาย | เป็น **"ช่องว่างที่เกิดจากการยังไม่เคยมีการสร้างขีดความสามารถขึ้นในประเทศ (Capability Never Built)"** ซึ่งต้องแก้ด้วยการวิจัยและพัฒนาระเบียบวิธีในบทที่ 5.2                                                                                                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                                                                                                |                                                    |
| **ข้อกำหนดเชิงคุณลักษณะ**  | **4**  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | **4**                                                                                                                                                                                                                                                                                                                                                                                                                                               | เกณฑ์ความละเอียดกริดเชิงพื้นที่, แนวทางการเลือกช่วงปีฐาน, นิยามหน่วยสถิติพื้นที่, รูปแบบการแส                                                                                                                                                                                                                                                  | เป็นข้อกำหนดเชิงมาตรฐาน ส่งต่อไปยังบทที่ 2 และ 5.2 |
| **รวม**                    | **52** |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |                                                                                                                                                                                                                                                                                                                                                                                                                                                     |                                                                                                                                                                                                                                                                                                                                                |                                                    |

*(หมายเหตุ: ในบัญชีรายการผลิตภัณฑ์สารสนเทศตามขอบเขตงานข้อ 5.3.4 มีผลิตภัณฑ์ที่รวบรวมได้จาก 56 หน่วยงานรวมทั้งสิ้น 114 ผลิตภัณฑ์ โดยมีผลิตภัณฑ์ที่ตรงกับความต้องการและถูกนำมาประกบใช้งานจำนวน 8 ผลิตภัณฑ์ (ครอบคลุมข้อกำหนดร้อยละ 15.4) ขณะที่ผลิตภัณฑ์ส่วนที่เหลือในบัญชีเป็นระบบเฉพาะทางของแต่ละหน่วยงานที่ไม่สอดคล้องกับข้อกำหนดของ 83 กรณีใช้งาน)*
