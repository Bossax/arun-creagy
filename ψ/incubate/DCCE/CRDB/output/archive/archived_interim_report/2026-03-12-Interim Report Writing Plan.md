...
- TOR mapping and interim report requirements: [`ψ/incubate/DCCE/CRDB/inbox_source/CRDB - TOR.md`](ψ/incubate/DCCE/CRDB/inbox_source/CRDB-TOR.md)
...
|---|---|---|---|---|
| **1.1 TOR intent recap** | The sponsor originally asked for a national adaptation information framework plus management structure, not merely a website facelift | [`ψ/incubate/DCCE/CRDB/inbox_source/CRDB - TOR.md`](ψ/incubate/DCCE/CRDB/inbox_source/CRDB-TOR.md) | CDM is introduced as the kind of conceptual management logic implicitly required by TOR 5.2.3 | MVPs are not yet the focus; they appear later as practical Phase 1 expressions |
