...
*   ~~ฐานข้อมูลสถิติความสูญเสียและความเสียหายทางเศรษฐกิจระดับชาติ (Macroeconomic Loss & Damage Database) `[5, MUST]`~~ ผลกระทบและความเสียหายจากอดีตถึงปัจจุบัน
...
* เครื่องมือการประเมินทางเศรษฐศาสตร์ของการลงทุนด้านการปรับตัว (Economics of Climate Adaptation Tool)
* ระเบียบวิธีประเมินต้นทุนและผลประโยชน์ (Cost-Benefit Analysis) และความคุ้มค่าในการลงทุนปรับตัว (Avoided Losses)
...
- Links to [[#4. เครื่องมือและบริการสารสนเทศด้านภูมิอากาศ (Tools & Services)]]
...
*   **3.3.1 แนวทางการวางแผนและการออกแบบโครงการแบบมีส่วนร่วม (Planning Guidelines & Participatory Project Design)**:
    *  ระเบียบวิธีประเมินต้นทุนและผลประโยชน์ (Cost-Benefit Analysis) และความคุ้มค่าในการลงทุนปรับตัว (Avoided Losses) `[3, MUST]`
    * เครื่องมือการประเมินทางเศรษฐศาสตร์ของการลงทุนด้านการปรับตัว (Economics of Climate Adaptation Tool)
...
*   **3.4.1 แนวทางการติดตามและประเมินผลการปรับตัว**:
    * กรอบการติดตามและประเมินผลการปรับตัวต่อการเปลี่ยนแปลงสภาพภูมิอากาสของประเทศไทย (info page) 
