...
*   **1.1.2 ความเสี่ยงสำคัญ และลำดับความสำคัญในการปรับตัวของประเทศไทย**:
    *   พื้นที่เป้าหมายวิกฤต (Hotspots) รายสาขาและระดับภูมิภาค
...
*   สรุปข้อมูลความสูญเสียและความเสียหายทางเศรษฐกิจระดับชาติ — บัตรสรุปพร้อมลิงก์ไปยังแดชบอร์ดฉบับเต็มที่ 3.2.4 *(shared build — see DEL-12/LD-1; the full dashboard is built once, at 3.2.4, not duplicated here)*
*   สรุปแนวโน้มภัยคุกคามและการเปิดรับภัยของประเทศ (Exposure Trends)
...
*   สรุปโปรไฟล์ความเสี่ยงเฉพาะสาขาเป้าหมายหลัก 6 สาขา (เกษตรกรรม, น้ำ, สาธารณสุข, ท่องเที่ยว, ป่าไม้/ระบบนิเวศ, พลังงานและการตั้งถิ่นฐาน)
...
*   สถานะการดำเนินการตามแผนการปรับตัวระดับชาติ (NAP Implementation Status) — *restored from v6; answers a different question than the Act's legal status below*
*   สถานะการดำเนินการและแผนดำเนินงานภายใต้ พ.ร.บ. การเปลี่ยนแปลงสภาพภูมิอากาศ (พ.ร.บ. โลกร้อน)
*   สรุปมาตรการทางกฎหมายและนโยบายที่ส่งเสริมการปรับตัว (เช่น พ.ร.บ. ป้องกันและบรรเทาสาธารณภัย, กฎกระทรวงผังเมือง)
...
*   **2.3.1 แหล่งทุนและการติดตามงบประมาณปรับตัว (Adaptation Finance Directory & Support Tracking)**:
    ...
    *   *(pending DCCE decision — see Brief E-1, remaining items below have no methodology or material behind them yet)*:
        ...
        *   การติดตามการรับเงินช่วยเหลือ เทคโนโลยี และความช่วยเหลือด้านวิชาการจากต่างประเทศ
...
*   **3.1.1 ข้อมูลสังเกตุการณ์**:
    ...
    *   ชุดข้อมูลสังเกตการณ์ผ่านดาวเทียม (Satellite-based observation parameters: พื้นที่ป่าไม้, การใช้ประโยชน์ที่ดิน Land Cover, แหล่งน้ำ, แนวปะการังฟอกขาว)
...
*   **3.2.2 การวิเคราะห์ความเสี่ยง** (Risk Analysis):
    ...
    *   **3.2.2.1 การติดตามภัยคุกคามที่เกิดขึ้นช้า (Slow-Onset Hazards Profile)**:
        ...
        *   ดัชนีการกัดเซาะชายฝั่งและการสูญเสียพื้นที่ชายหาดเชิงสถิติ
...
*   **3.2.4 ความสูญเสียและความเสียหาย (Loss and Damage)** *(shared build — see DEL-12/LD-1; the same DDPM-sourced dataset backs 2.1's summary card and 1.1.1's disaster history)*:
    ...
    *   แดชบอร์ดสรุปสถิติความสูญเสียทางเศรษฐกิจ (Economic Losses) และทางกายภาพจากภัยสภาพอากาศในอดีต — full build lives here; 2.1 links to this, does not duplicate it
...
*   **3.3.4 กรณีศึกษาการวางแผนการปรับตัว**:
    ...
    *   *(open item, not resolved this session — this page's relationship to 3.4.3's flagship-project case studies wasn't put to a decision; flagged as a candidate for a future pass, not merged or split here)*
*   **3.3.5 โครงการที่กำลังดำเนินการ (Project Tracking Status)**:
    *   ระบบติดตามสถานะและการดำเนินงานโครงการปรับตัวของประเทศ (เช่น โครงการประกันภัยพืชผล, การใช้งานระบบฐานข้อมูล Agri-Map, การปรับปรุงโครงสร้างควบคุมน้ำ) *(pending DCCE resourcing decision — see Brief E-3; existed in v6 too, but nothing tracks this anywhere yet — flagged honestly rather than shown as a working system)*
    *   การติดตามการเงินเพื่อการปรับตัว — *(pending DCCE decision — see Brief E-1, same undecided finance-tracking service as 2.3.1; see that page's pending items rather than a separate build here — the v8 mockups had built this twice, once here as a Sankey diagram and once at 2.3.1, with conflicting figures)*
...
*   **3.4.2 ระบบฐานข้อมูลด้านการติดตามและประเมินผลของประเทศไทย (Adaptation M&E Platform)**:
    *   ดัชนีติดตามความก้าวหน้าและระดับการลดความเปราะบางรายภาคส่วนและรายจังหวัด (National M&E Tracker)
...
- Risk map & profile: DEL-2/DEL-13, one capability across 1.2, 2.2, 2.4-link, 4.2
- Risk framing & worked examples: DEL-7, one explainer set across 1.1.1, 3.1, 3.2
- Policy & institutional content: DEL-8, one deliverable across 2.3.2, 3.3.2
...
- ECA / Cost-Benefit / Avoided Losses (2.3, 3.3.1) — Brief E-1
- Budget tagging, aid/tech-transfer tracking, private-sector finance engagement (2.3.1) — Brief E-1
- Damage function library (3.2.1) — Brief E-1
- Uncertainty governance standard (3.1.3) — Brief E-2
- Project Tracking Status (3.3.5) — Brief E-3
- Adaptation Finance Tracker (3.3.5) — Brief E-1, resolves the mockup's ฿100M-vs-฿42,500M conflict by not building two versions
...
- 2.4: kept as a pure router link to Section 4, rather than rebuilt as a 6-item planning hub — the map/profile content it would have carried is already reachable via 1.2/2.2/4.2

**Open, not resolved this session:**
- 3.3.4 vs. 3.4.3: whether the two case-study libraries (adaptation planning vs. flagship M&E projects) should stay separate or merge — flagged for a future pass
