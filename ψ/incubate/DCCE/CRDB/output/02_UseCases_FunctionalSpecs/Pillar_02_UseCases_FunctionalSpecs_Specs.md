...
## 2. Evidence Base (Autoritative Sources)
This deliverable is grounded in the following validated evidence:
- **Interviews**: [`NCAIF_Use_Cases.md`](ψ/incubate/DCCE/CRDB/output/02_UseCases_FunctionalSpecs/NCAIF_Use_Cases.md)
- **Canonical Use Case Menu**: [`canoncial_use_cases.md`](ψ/incubate/DCCE/CRDB/output/consultation_workshop/canoncial_use_cases.md)
- **Workshop Analysis**: 
...
## 3. Use Case Inventory Table
(See [`Pillar_02_UseCases_FunctionalSpecs_Inventory.csv`](ψ/incubate/DCCE/CRDB/output/02_UseCases_FunctionalSpecs/Pillar_02_UseCases_FunctionalSpecs_Inventory.csv))
...
## 6. Phase 1 vs Deferred Boundary
