# NCAIF Detailed Sitemap v7.0 (Service-Centric Integration Baseline)

**Status**: PROPOSED BASELINE (Integrated with BTR Compliance & User Personas)
...
> - `1` = Section 1: National circumstances, institutional arrangements, legal framework (formerly Section A)
> - `2` = Section 2: Climate evidence, hazards, sector risks (formerly Section B)
> - `3` = Section 3: National adaptation priorities, strategies, barriers (formerly Section C)
> - `4` = Section 4: Implementation progress, indicators, funding flows (formerly Section D)
> - `5` = Section 5: Loss and Damage, disaster risk management support (formerly Section E)
> - `6` = Section 6: Good practices, lessons learned (formerly Section F)
...
*   แนวทางการเงินเพื่อการปรับตัว (Adaptation Finance Directory): รายการแหล่งทุนภาครัฐ/เอกชน/ต่างประเทศ และคู่มือวิเคราะห์ความคุ้มค่าโครงการเพื่อประกอบการจัดทำงบประมาณชี้แจง สตง. `[4, MUST]`
...
*   **3.1.2 ปัจจัยขับเคลื่อนทางภูมิอากาศ**:
    *   ข้อมูลClimatologyและตัวแปรทางสภาพภูมิอากาศที่สำคัญ (Temperature trends, Rainfall intensity changes) `[2, MUST]`
    *   คู่มือและบทอธิบายการใช้งานฉากทัศน์ภูมิอากาศ (Climate Scenarios)
...
*   **3.3.1 แนวทางการวางแผนการปรับตัว**:
    ...
    *   แนวทางการบูรณาการมิติด้านเพศวิถี ความเปราะบางทางสังคม (Gender & Social Inclusion) ในการวางแผน `[3, SHOULD]`
*   **3.3.2 เส้นทางกลยุทธ์การปรับตัวของประเทศ (Roadmap)**:
    *   แผนภาพและเส้นทางกลยุทธ์การดำเนินงาน (NAP Roadmap Execution Staging) `[3, MUST]`
    *   รายงานการวิเคราะห์อุปสรรคเชิงระบบ (Systemic Barriers & Challenges) และแนวทางแก้ไขทางกฎหมายและการเงิน `[3, MUST]`
...
*   **3.3.4 กรณีศึกษาการวางแผนการปรับตัว**:
    *   คลังข้อมูลแผนจัดการความเสี่ยงสภาพภูมิอากาศและนโยบายเชิงสถาบันของท้องถิ่นและภาคเอกชน
*   **3.3.5 โครงการที่กำลังดำเนินการ (Project Tracking Status)**:
    ...
    *   ตัวชี้วัดความพร้อมของโครงการงบประมาณ
