"""Stage 1 export loading helpers for CRI Impact App v3."""
...
def build_province_geojson(dataset: dict[str, Any]) -> dict[str, Any]:
    ...
    for feature in base_geojson.get("features", []):
        ...
        new_features.append({
            ...
            "geometry": feature.get("geometry"), # Reference original to save memory
...
def tambon_geojson_for_province(dataset: dict[str, Any], province_code: str) -> dict[str, Any]:
    ...
    for feature in base_geojson.get("features", []):
        ...
        new_features.append({
            "type": feature.get("type", "Feature"),
            "geometry": feature.get("geometry"), # Reference original
            "properties": new_props
        })
